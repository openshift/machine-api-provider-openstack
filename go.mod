...
replace (
	sigs.k8s.io/cluster-api => sigs.k8s.io/cluster-api v1.3.0
	sigs.k8s.io/cluster-api-provider-openstack => github.com/shiftstack/cluster-api-provider-openstack v0.0.0-20230131140434-9bb6e5823c81
)
